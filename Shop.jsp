...
String c = (String) ses.getAttribute("cat");
%>
<!DOCTYPE html>
<html lang="zxx">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3">
					...
					%>
					<%int i=0; for (Categorie a : cat) {i++;%> 
                                    <div class="card">

            
                                        <div class="card-heading active">
                                            <a href="cats?cat=<%=a.getIdC()%>"><%=a.getNom()%></a>
                                        </div>
                          ...
                          ArrayList<Produit> Produits =PM.findCat(a.getIdC());
                         for( Produit b:Produits){   %>
                         
                                                    <li><a href="#"><%=b.getNom()%></a></li>
                    ...
                    <div class="row">
                       ...
                       <% 
                         ...
                         PManager PM = new  PManager();
                          ...
                          ArrayList<Produit> Produits =PM.findCat(c);
